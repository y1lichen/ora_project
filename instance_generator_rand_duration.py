...
class InstanceGenerator:
    ...
    def __init__(self, num_patients=15, arrival_interval=10, random_seed=42, fixed_path_seed=42):
        np.random.seed(random_seed)
        random.seed(random_seed)
        self.fixed_rng = np.random.RandomState(seed=fixed_path_seed)
    ...
    def generate_data(self, num_scenarios=30):
        ...
        for pid in range(self.num_patients):
            ...
            path_idx = self.fixed_rng.choice(len(self.pathway_data), p=path_probs)
